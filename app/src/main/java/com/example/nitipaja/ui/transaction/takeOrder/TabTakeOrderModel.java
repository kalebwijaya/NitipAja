...
public class TabTakeOrderModel {
    ...
    public TabTakeOrderModel() {
    }

    public TabTakeOrderModel(String itemID, String itemName, String itemLocation, String itemPrice, String itemDescription, String itemCategory, String itemQuantity, String userID, String imageURL, String itemStatus, String takenOrderBy) {
        this.itemID = itemID;
